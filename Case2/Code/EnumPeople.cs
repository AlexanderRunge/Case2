...
internal enum EnumPeople
{
    ...
    [Subject(SubjectName = "Studieteknik", Teacher = new string[] { "Niels Olesen" }, Attendees = new string[] { "Alexander Runge", "Amanda Gudmand", "Camilla Kløjgaard", "Dennis Paaske", "Iheb Boukthir", "Jakob Rasmussen", "Micki Olsen", "Mhd Adil Ajak", "Mikkel Rantala", "Mikkel Jensen", "Mikkel Kjærgaard", "Niclas Jensen", "Ozan Korkmaz", "Rasmus Wiell", "Rune Hansen", "Sanjit Poudel" })] Studieteknik,
